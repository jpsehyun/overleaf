...
For this, the project is directed into answering these following questions
\begin{enumerate}
    \item 1. Can augmented reality technology be utilized to create an immersive environment for the users?
    \item 2. "How can the integration of augmented reality simulations aid in teaching history through the use of affective learning?"
\end{enumerate}
