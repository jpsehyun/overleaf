...
The project aims to develop an augmented reality simulation application that includes affective learning to enhance the user's understanding of historical events, focusing on the Bataan Death March. The researchers aims to investigate and address the factors causing students' hardship in history classes and create ways which students could absorb the lesson better.
% option-1
% The researchers seek to understand and address the factors causing students'
% difficulties in history classes and develop methods for students to better
% comprehend the lessons.

% option-2
% The researchers aim to investigate and address the factors causing students'
% difficulties in history classes and develop strategies to enhance students'
% learning experience.
