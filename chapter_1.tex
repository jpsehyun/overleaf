...
A study by Lampropoulos et. al. has compiled 188 editorials and used bibliometric analysis and scientific mapping approach to create a general trend on extended reality technologies. The results show that these technologies are increasingly being adopted into the academe to improve teaching and learning in traditional classrooms. It has also shown that affective learning is significantly different from 
