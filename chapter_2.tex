...
There are numerous factors in AR which can be utilized to bring out an immersion-based feeling from the users. Realism, interactivity with the virtual world, streo sounds, graphics, and narratives are notable factors which can be used to create an immersion in AR \cite{marto2022}.

Literature by \cite{immersionAR} emphasizes on the relationship between a flow, presence, and immersion in determining user experience in AR. Flow is defined as the mental state where an individual has a complete involvement and enjoyment in the process of the activty, while presence refers to the level of significance of another person in the interaction and the resulting importance of the interpersonal relationship. The study suggests that these three factors had a significant effect on user satisfaction by granting the users a sense of confirmation
% option-1
% Presence is defined as the extent of importance of another individual in the
% interaction and the subsequent significance of the interpersonal relationship.
% The research indicates that these three factors significantly impacted user
% satisfaction by providing users with a sense of validation.

% option-2
% Presence is the level of significance of another person in the interaction and
% the resulting importance of the interpersonal relationship. The study indicates
% that these three factors significantly affected user satisfaction by providing
% users with a sense of confirmation.

% option-3
% Presence in an interaction refers to the significance level of another person and
% the resulting importance of the interpersonal relationship. The study indicates
% that these three factors significantly impacted user satisfaction by providing
% users with a sense of confirmation. 
