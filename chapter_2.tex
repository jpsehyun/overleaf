...
% option-1
% Several factors in augmented reality (AR) can be leveraged to evoke an immersive
% experience for users. Realism, interactivity with the virtual environment,
% spatial sounds, graphics, and storytelling are significant elements that
% contribute to creating immersion in AR (Marto, 2022).

% option-2
% Several factors in augmented reality (AR) can be leveraged to evoke an immersive
% experience for users. Realism, interactivity with the virtual environment,
% spatial sounds, graphics, and storytelling are key elements that contribute to
% creating immersion in AR (Marto, 2022).

% option-3
% Several factors in augmented reality (AR) can be employed to evoke an immersive
% experience for users. Realism, interactivity with the virtual environment,
% spatial sounds, graphics, and narratives are key elements that contribute to
% creating immersion in AR (Marto, 2022). 

Literature by \cite{immersionAR} emphasizes on the relationship between a flow, presence, and immersion in determining user experience in AR. Flow is defined as the mental state where an individual has a complete involvement and enjoyment in the process of the activty, while presence refers to the level of significance of another person in the interaction and the resulting importance of the interpersonal relationship. The study suggests that these three factors had a significant impact on user satisfaction by providing users a sense of confirmation, which refers to users' perceptions of the alignment between their expectations of technology usage and its actual performance.
