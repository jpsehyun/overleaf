...
The word \textit{immersion} could have different meaning based on the context it is being used at. In the context of Virtual Reality(VR), immersion is considered a user's perception of being present in an artificial world \cite{immersionAR}. But what does immersion portrays in a context of Augmented Reality (AR) technology? 
