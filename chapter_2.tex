...
Literature by \cite{immersionAR} emphasizes on relation between a flow, presence, immersion in determining a user experience in AR simulations. Flow is defined as the mental state which a person has a complete involvement and enjoyment in the process of the activty, and presence is defined as 
