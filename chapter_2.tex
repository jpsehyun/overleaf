...
According to \cite{immersionAR}, immersion in AR refers to an experience which allows the users to connect to the virtual world presented by AR. Immersion in AR is conceptualized as a mental sensation of engagement and a cognitive feeling of involvement. It is used to enhance and augment the real-world experiences of the users without fully disconnectiom them from reality \cite{midles2024}.
