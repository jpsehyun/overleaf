...
The literature review delved deep into both AR and VR technology and points out key concepts that are important in the application of those technology. The study's findings leads a guidance for the creation of the applicaiton and to provide an immersive and effective AR experience. Lastly, the study created a framework from which the project can be built upon as seen from the figure below \cite{suh2018}.
