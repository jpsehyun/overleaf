...
The term \textit{immersion} can have different definitions depending on the context in which it is used. In Virtual Reality (VR), immersion refers to a user's perception and sense of presence in a computer-generated world \cite{immersionAR}. This is achieved through surrounding the user with stimulis such as sound and images to provide a total environment and create hallucinations for them. However, what does immersion signify in the context of Augmented Reality (AR) technology? 
