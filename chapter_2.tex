...
The term \textit{immersion} can have different definitions depending on the context in which it is used. In Virtual Reality (VR), immersion refers to a user's perception and sense of presence in a computer-generated world \cite{immersionAR}. Immersion in VR is achieved through surrounding the user with stimuli such as sound and images to create a total environment and induce hallucinations for them. However, what does immersion signify in the context of Augmented Reality (AR) technology? 

According to \cite{immersionAR}, in context of AR, immersion is an experience which allows the users to connect to the world inside AR. Immersion in AR is conceptualized as a mental sensation of engagement.
% option-1
% In the context of augmented reality (AR), immersion refers to the experience that
% enables users to connect with the virtual world. It is conceptualized as a mental
% sensation of engagement.

% option-2
% As per the study by \cite{immersionAR}, immersion in augmented reality (AR)
% refers to the user's ability to engage with the virtual world presented by AR. It
% is characterized as a cognitive state of deep involvement.

% option-3
% According to the source cited, in the context of augmented reality (AR),
% immersion refers to an experience that enables users to engage with the virtual
% world within AR. Immersion in AR is defined as a cognitive feeling of
% involvement. 
